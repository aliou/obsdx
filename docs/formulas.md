Formulas allow you to create calculated properties in [Bases](https://obsidian.md/help/bases) using data from other [properties](https://obsidian.md/help/properties). You can perform calculations, manipulate text, work with dates, and more.
...
The formula editor will autocomplete [function](https://obsidian.md/help/bases/functions) and property names as you type to validate your formula syntax. A green checkmark appears when your formula is valid.

Once created, you can use a formula property like any other property in your base. Add it to [views](https://obsidian.md/help/bases/views), use it in filters, sort by it, and more.
...
- **Note properties** — Properties from a note's [frontmatter](https://obsidian.md/help/properties).
...
Learn more in [Bases syntax](https://obsidian.md/help/bases/syntax#Operators).

### Use functions

Functions perform operations on values. The available functions depend on the type of value you're working with. See the complete list of [Functions](https://obsidian.md/help/bases/functions).
