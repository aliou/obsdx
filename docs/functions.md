Functions are used in [Bases](https://obsidian.md/help/bases) to manipulate data from [properties](https://obsidian.md/help/properties) in [filters](https://obsidian.md/help/bases/views#Filters) and [formulas](https://obsidian.md/help/formulas). See the [bases syntax](https://obsidian.md/help/bases/syntax) reference to learn more about how you can use functions.

Aside from [Global](https://obsidian.md/help/bases/functions#Global) functions, most functions depend on the type of value you want to modify:
...
- Parse a string as a duration. See the [date arithmetic section](https://obsidian.md/help/bases/syntax#Date%20arithmetic) for the `value` string format.
...
Functions you can use with a date and time such as `date("2025-05-27")`. Date comparisons can be done using [date arithmetic](https://obsidian.md/help/bases/syntax#Date%20arithmetic).
...
- Example: `file.hasTag("tag1", "tag2")` returns `true` if the file has tag `#tag1` or `#tag2`. It also includes any [nested tags](https://obsidian.md/help/tags#Nested%20tags), such as `#tag1/a` or `#tag2/b`.
