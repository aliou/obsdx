When you [create a base](https://obsidian.md/help/bases/create-base) in Obsidian, it is saved as a `.base` file. Bases are typically edited using the app interface, but the syntax can also be edited manually, and embedded in a code block.

The [Bases](https://obsidian.md/help/bases) syntax defines [Views](https://obsidian.md/help/bases/views), filters, and [formulas](https://obsidian.md/help/formulas). Bases must be valid YAML conforming to the schema defined below.
...
- A function. A variety of [Functions](https://obsidian.md/help/bases/functions) are built-in, and plugins can add additional functions.

The syntax and available functions for filters and formulas are the same.

### Formulas

The `formulas` section defines [formula properties](https://obsidian.md/help/formulas) that can be displayed across all views in the base file.
...
Formula properties support basic arithmetic operators and a variety of built-in [Functions](https://obsidian.md/help/bases/functions). In the future, plugins will be able to add functions for use in formulas.
...
[Note properties](https://obsidian.md/help/properties) are only available for Markdown files, and are stored in the YAML frontmatter of each note. These properties can be accessed using the format `note.author` or simply `author` as a shorthand.

### File properties

File properties refer to the file currently being tested or evaluated. File properties are available for all [file types](https://obsidian.md/help/file-formats), including attachments.
...
The global [function](https://obsidian.md/help/bases/functions) `today()` can be used to get the current date, and `now()` can be used to get the current date with time.
...
See the [list of functions](https://obsidian.md/help/bases/functions) that can be used in formulas and [filters](https://obsidian.md/help/bases/views).
...
Dates represent a specific date, or a date and time depending on the function used to create them, or that type that has been assigned to the [property](https://obsidian.md/help/properties).
...
- Many other [fields and functions](https://obsidian.md/help/bases/functions) are available on date objects.
...
[Wikilinks](https://obsidian.md/help/link-notes) in [frontmatter properties](https://obsidian.md/help/properties) are automatically recognized as Link objects. Links will render as a clickable link in the [view](https://obsidian.md/help/bases/views).

- To construct a link, use the global `link` [function](https://obsidian.md/help/bases/functions), for example `link("filename")` or `link("https://obsidian.md")`.
